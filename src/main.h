...
const int64_t nBlockSequentialAlgoRuleStart3 = 1400000; // block where sequential algo rule starts
...
const int nBlockSequentialAlgoMaxCount3 = 6; // maximum sequential blocks of same algo
...
public:
    ...
    CBigNum GetPrevWorkForAlgoWithDecay2(int algo) const
    {
        int nDistance = 0;
        CBigNum nWork;
        CBlockIndex* pindex = this->pprev;
