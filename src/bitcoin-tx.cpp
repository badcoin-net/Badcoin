...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s badcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  badcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded badcoin transaction") + "\n" +
              "  badcoin-tx [options] -create [commands]   " + _("Create hex-encoded badcoin transaction") + "\n" +
              "\n";
