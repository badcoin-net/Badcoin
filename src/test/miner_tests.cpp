...
BOOST_AUTO_TEST_CASE(CreateNewBlock_validity)
{
    ...
    BOOST_CHECK(pblocktemplate = BlockAssembler(chainparams, ALGO_SHA256D).CreateNewBlock(scriptPubKey));
    ...
    BOOST_CHECK_THROW(BlockAssembler(chainparams, ALGO_SHA256D).CreateNewBlock(scriptPubKey), std::runtime_error);
    mempool.clear();
